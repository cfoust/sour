...
extern void sendedit(int client, ENetPacket *packet);
...
//extern void filtertext(char dst, const char src, bool whitespace = true, bool cock = false, int len = sizeof(string)-1));
extern void localconnect();
extern const char *disconnectreason(int reason);
extern void disconnect_client(int n, int reason);
extern void connect_client(int n);
extern void requestmap(const char * mapname, int mode);
extern void setclientname(int n, const char *name);
extern void healthy();
